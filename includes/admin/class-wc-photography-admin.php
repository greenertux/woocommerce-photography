...
class WC_Photography_Admin {
	...
	public function enqueue_scripts() {
		...
		if ( 'edit-product' == $screen->id ) {
			wp_enqueue_style( 'wc-photography-admin', WC_Photography::get_assets_url() . 'css/admin.css', array(), WC_Photography::VERSION, 'all' );
		}
		...
		if ( 'product' == $screen->id ) {
			wp_enqueue_script( 'wc-photography-admin-products', WC_Photography::get_assets_url() . 'js/admin/product' . $suffix . '.js', array( 'jquery' ), WC_Photography::VERSION, true );
		}

		if ( 'images_collections' == $screen->taxonomy ) {
			wp_enqueue_media();
			wp_enqueue_style( 'wc-photography-admin-collections', WC_Photography::get_assets_url() . 'css/collections.css', array(), WC_Photography::VERSION, 'all' );
			wp_enqueue_script( 'wc-photography-admin-collections', WC_Photography::get_assets_url() . 'js/admin/collections' . $suffix . '.js', array( 'jquery' ), WC_Photography::VERSION, true );
			wp_localize_script(
